...
function analyzeColor(color){
    ...
    switch(color) {
        case "white":
            ...
            break;
        case "black":
            return "black is the color of the void of space";
            break;
        case "orange":
            return "orange is my favorite color!";
        case "red":
...
console.log(analyzeColor("blurple"));
...
function calculateTotal(luckyNumber, totalAmount){
    if(luckyNumber === 0){
        return "Your lucky number is... " + luckyNumber + ". You get no discount, your total is: $" + totalAmount;
    } else if (luckyNumber === 1){
        return "Your lucky number is... " + luckyNumber + ". You get a %10 discount, your total is: $" + (totalAmount - (totalAmount * 0.1));
    } else if (luckyNumber === 2){
        return "Your lucky number is... " + luckyNumber + ". You get a %25 discount, your total is: $" + (totalAmount - (totalAmount * 0.25));
...
const userInput = confirm("Would you like to enter a number??");
if (userInput === true){
